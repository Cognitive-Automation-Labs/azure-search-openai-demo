...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping Cognitive Automation Labs employees with understanding policy information. " \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching the Microsoft policy information such performance policies, etc."
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str, callbacks: Callbacks = None):
        super().__init__(filename="data/employeeinfo.csv", 
                         key_field="name", 
                         name="Employee", 
                         description="useful for answering questions about the employee, and their related policies",
                         callbacks=callbacks)
